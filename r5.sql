INSERT INTO Lump(game, index_h, index_d, name, stage) VALUES
    ...
    ('r5', '006A', 106, 'CELL_BSP_NODES',                 1),
    ('r5', '006B', 107, 'CELLS',                          1),
    ('r5', '006C', 108, 'PORTALS',                        0),
    ('r5', '006D', 109, 'PORTAL_VERTICES',                0),
    ('r5', '006E', 110, 'PORTAL_EDGES',                   0),
    ('r5', '006F', 111, 'PORTAL_VERTEX_EDGES',            0),
    ('r5', '0070', 112, 'PORTAL_VERTEX_REFERENCES',       0),
    ('r5', '0071', 113, 'PORTAL_EDGE_REFERENCES',         0),
    ('r5', '0072', 114, 'PORTAL_EDGE_INTERSECT_EDGE',     0),
    ('r5', '0073', 115, 'PORTAL_EDGE_INTERSECT_VERTEX',   0),
    ('r5', '0074', 116, 'PORTAL_EDGE_INTERSECT_HEADER',   0),
